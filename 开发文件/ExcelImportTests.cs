...
internal static class ExcelImportTests
{
    public static int Main(string[] args)
    {
        ...
        try
        {
            ...
            int platforms = sources.Count(source => !String.IsNullOrWhiteSpace(source.Platform));
            Console.WriteLine("Excel sheets=" + plans.Count + ", sources=" + sources.Count + ", authors=" + authors + ", platforms=" + platforms +
            ...
            return plans.Count > 0 && sources.Count > 0 && authors > 0 && platforms > 0 ? 0 : 1;
        }
        catch (Exception ex)
        {
